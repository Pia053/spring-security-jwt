...
@NoArgsConstructor
@AllArgsConstructor
public class UserSearchQueryCriteriaConsumer implements Consumer<SearchCritetia> {

    private CriteriaBuilder builder;
    private Root root; // class được chỉ định
    private Predicate predicate; // đối tượng chỉ định

    @Override
    public void accept(SearchCritetia param) {
